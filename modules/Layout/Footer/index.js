        ...
        <Container maxWidth="lg">
          <Grid container>
            ...
            <Grid item xs={12} md={2}>
                <span className={classes.span}>Features</span>
            ...
            <Grid item xs={12} md={2}>
            <span className={classes.span}>Resources</span>
              <ul className={classes.ul}>
                <li>Blog</li>
                <li>Developers</li>
                <li>Support</li>
